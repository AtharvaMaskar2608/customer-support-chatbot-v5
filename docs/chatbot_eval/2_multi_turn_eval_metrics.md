# Multi-Turn Evaluation Metrics (/guides/guides-multi-turn-evaluation-metrics)
...
## Categories of Multi-Turn Metrics [#categories-of-multi-turn-metrics]
...
### Conversation Completeness Metric [#conversation-completeness-metric]
...
### Turn Relevancy Metric [#turn-relevancy-metric]
...
### Knowledge Retention Metric [#knowledge-retention-metric]
...
### Topic Adherence Metric [#topic-adherence-metric]
...
## Agentic Multi-Turn Metrics [#agentic-multi-turn-metrics]

These metrics evaluate tool-using and goal-oriented behavior within multi-turn conversations.

### Goal Accuracy Metric [#goal-accuracy-metric]
...
### Tool Use Metric [#tool-use-metric]
...
## RAG Multi-Turn Metrics [#rag-multi-turn-metrics]
...
## Custom Multi-Turn Metrics [#custom-multi-turn-metrics]
...
### Conversational DAG Metric [#conversational-dag-metric]
