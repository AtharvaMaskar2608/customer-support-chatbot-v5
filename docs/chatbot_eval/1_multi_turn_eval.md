# Multi-Turn Evaluation (/guides/guides-multi-turn-evaluation)
...
*For a deeper dive into multi-turn metrics, see the [Multi-Turn Evaluation Metrics guide](/guides/guides-multi-turn-evaluation-metrics). For automating conversation generation, see the [Multi-Turn Simulation guide](/guides/guides-multi-turn-simulation).*

## Multi-Turn vs Single-Turn Evaluation [#multi-turn-vs-single-turn-evaluation]
...
### Single-Turn Evaluation [#single-turn-evaluation]
...
## Common Pitfalls in Multi-Turn AI [#common-pitfalls-in-multi-turn-ai]
...
### Context & Memory Failures [#context--memory-failures]
...
### Response Quality Failures [#response-quality-failures]
...
### Conversation Flow Failures [#conversation-flow-failures]
...
## Workflows for Multi-turn Evals [#workflows-for-multi-turn-evals]
...
## Multi-Turn Evals In Development [#multi-turn-evals-in-development]
...
#### Returning Rich Turns [#returning-rich-turns]
...
### Choose and Run Metrics [#choose-and-run-metrics]
...
<VideoDisplayer src="ASSETS.conversationTestReport" confidentUrl="https://www.confident-ai.com/docs/llm-evaluation/dashboards/testing-reports" label="Multi-turn test reports on Confident AI" description="Review full conversations alongside their metric scores and reasons." />
...
### Using Custom Criteria [#using-custom-criteria]
...
## Multi-Turn Evals In Production [#multi-turn-evals-in-production]
...
### Setting Up Production Monitoring [#setting-up-production-monitoring]
...
<Steps>
  <Step>
    ### Create a metric collection [#create-a-metric-collection]
    ...
    <VideoDisplayer src="ASSETS.metricsCreateCollection" confidentUrl="/docs/llm-tracing/evaluations" label="Create a metric collection on Confident AI" description="Group the metrics you want to run automatically on incoming threads." />
  </Step>

  <Step>
    ### Log conversations as threads [#log-conversations-as-threads]
    ...
    <VideoDisplayer src="ASSETS.tracingThreads" confidentUrl="/docs/llm-tracing/evaluations#offline-evaluations" label="Monitor conversations on Confident AI" description="Replay production threads and evaluate them with your metrics." />
  </Step>

  <Step>
    ### Feed production data back to development [#feed-production-data-back-to-development]
