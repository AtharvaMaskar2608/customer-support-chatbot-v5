...
## Common Pitfalls in RAG Pipelines [#common-pitfalls-in-rag-pipelines]
...
*(To evaluate generation on customized criteria, you should use the [`GEval`](/docs/metrics-llm-evals) metric instead, which covers all custom use cases.)*
...
### Beyond Generic Evaluation [#beyond-generic-evaluation]
...
## E2E RAG Evaluation [#e2e-rag-evaluation]
...
## Unit Testing RAG Systems in CI/CD [#unit-testing-rag-systems-in-cicd]
...
## Multi-Turn RAG Evaluation [#multi-turn-rag-evaluation]
...
### Multi-Turn RAG Metrics [#multi-turn-rag-metrics]
...
### Setting Up Multi-Turn RAG Evaluation [#setting-up-multi-turn-rag-evaluation]
...
### Using Simulation for Multi-Turn RAG [#using-simulation-for-multi-turn-rag]
...
## Optimizing On Hyperparameters [#optimizing-on-hyperparameters]
