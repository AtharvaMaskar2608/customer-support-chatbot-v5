# Tracing Multi-Turn Applications (/guides/guides-tracing-multi-turn)
...
## Common Pitfalls in Multi-Turn Systems [#common-pitfalls-in-multi-turn-systems]
...
## How Multi-Turn Tracing Works [#how-multi-turn-tracing-works]
...
## Instrumenting Conversation Turns [#instrumenting-conversation-turns]
...
## Tracking Per-Turn Context [#tracking-per-turn-context]
...
## Tagging and Filtering Threads [#tagging-and-filtering-threads]
...
## Multi-Turn Observability In Production [#multi-turn-observability-in-production]
...
<Steps>
  <Step>
    ### Create a multi-turn metric collection [#create-a-multi-turn-metric-collection]
    ...
    <VideoDisplayer src="ASSETS.metricsCreateCollection" confidentUrl="/docs/llm-tracing/evaluations" label="Create a multi-turn metric collection on Confident AI" description="Group conversational metrics to run on your production threads." />
  </Step>

  <Step>
    ### Attach the collection to your trace [#attach-the-collection-to-your-trace]
  ...
  <Step>
    ### Monitor conversational drift [#monitor-conversational-drift]
    ...
    <VideoDisplayer src="ASSETS.tracingThreads" confidentUrl="/docs/llm-tracing/evaluations" label="Track and replay conversational threads on Confident AI" description="Inspect every turn of a conversation exactly as your users saw it." />
  </Step>
</Steps>

### Triggering Evaluation On-Demand [#triggering-evaluation-on-demand]
