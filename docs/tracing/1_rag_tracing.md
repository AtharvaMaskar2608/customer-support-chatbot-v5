# Tracing RAG Applications (/guides/guides-tracing-rag)
...
## Common Pitfalls in LLM Pipelines [#common-pitfalls-in-llm-pipelines]
...
### Monolithic Functions [#monolithic-functions]
...
### Auto-Patching LLM Clients [#auto-patching-llm-clients]
...
### Connecting to Confident AI (Optional) [#connecting-to-confident-ai-optional]
...
### Configuring Environments and Sampling [#configuring-environments-and-sampling]
...
## Instrumenting Your LLM Pipeline [#instrumenting-your-llm-pipeline]
...
## Tracking Dynamic Context [#tracking-dynamic-context]
...
### `update_current_span()` Parameters [#update_current_span-parameters]
...
### `update_current_trace()` Parameters [#update_current_trace-parameters]
...
## Evaluating Your Pipeline with Traces [#evaluating-your-pipeline-with-traces]
...
## Accessing Raw Traces Locally [#accessing-raw-traces-locally]
...
## LLM Observability In Production [#llm-observability-in-production]
...
<Steps>
  <Step>
    ...
    <VideoDisplayer src="ASSETS.metricsCreateCollection" confidentUrl="/docs/llm-tracing/evaluations" label="Create a metric collection on Confident AI" description="Group RAG metrics to score retrievals and generations automatically." />
  </Step>

  <Step>
    ### Attach the collection to your spans [#attach-the-collection-to-your-spans]
  ...
  <Step>
    ### Monitor and analyze traces [#monitor-and-analyze-traces]
    ...
    <VideoDisplayer src="ASSETS.tracingTraces" confidentUrl="/docs/llm-tracing/evaluations" label="Track tracing performance over time on Confident AI" description="Watch metric scores trend across your RAG pipeline in production." />
  </Step>
</Steps>
